...
export class ClassGameBoard extends Component<TClassAppSetHandlers, TClassGameBoard> {
  state = {
    userGuess: '',
    fishIndexCount: 0,
  }
  ...
  handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (userGuess.toLowerCase() === initialFishes[fishIndexCount].name.toLowerCase()) {
      handleCorrectGuess();
    } else {
  ...
  render() {
    ...
    return (
      <div id="game-board">
        ...
        <form id="fish-guess-form" onSubmit={(e: React.FormEvent<HTMLFormElement>) => {this.handleSubmit(e)}} >
